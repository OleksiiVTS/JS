...
const cars = [
  ...
  // const getCarsWithType = (cars, type) => cars.filter(({type: carTipe}) => carTipe === type);
  ...
  // const sortByAscendingAmount = cars => [...cars].sort((amountA, amountB) => amountA.amount - amountB.amount);
  ...
  // const sortByDescendingPrice = cars => [...cars].sort((amountA, amountB) => amountB.price - amountA.price);
  ...
  // назвою моделі в алфавітному та зворотному алфавітному порядку, в залежності 
  // від значення параметра order.
